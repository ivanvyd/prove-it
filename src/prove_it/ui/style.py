...
.stApp {
  ...
  background-image:
    ...
    url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 170 200'><defs><radialGradient id='b' cx='50%25' cy='35%25' r='75%25'><stop offset='0' stop-color='%23FFF7DC'/><stop offset='.55' stop-color='%23FFF3D0'/><stop offset='1' stop-color='%23F2C877'/></radialGradient><linearGradient id='s' x1='0' y1='0' x2='0' y2='1'><stop offset='0' stop-color='%23464D58'/><stop offset='.6' stop-color='%233A4048'/><stop offset='1' stop-color='%2323262B'/></linearGradient></defs><rect x='80' y='0' width='10' height='9' rx='2' fill='%232A313A'/><rect x='84' y='7' width='2' height='108' fill='%232A313A'/><circle cx='85' cy='150' r='10' fill='url(%23b)'/><path d='M85 110 C 64 112 51 130 48 151 L 122 151 C 119 130 106 112 85 110 Z' fill='url(%23s)'/><ellipse cx='85' cy='151' rx='37' ry='6' fill='%2323262B'/><ellipse cx='85' cy='151' rx='27' ry='4.2' fill='%23F2C877' opacity='.9'/><ellipse cx='85' cy='153' rx='16' ry='5' fill='%23FFF3D0' opacity='.92'/><ellipse cx='85' cy='158' rx='22' ry='7' fill='%23F2C877' opacity='.26'/></svg>"),
